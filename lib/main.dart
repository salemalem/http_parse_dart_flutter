...
// https://creativebracket.com/write-your-first-web-scraper/

void main() {
  String url = "https://mp3-tut.net/search?query=lil%20";
//  String url = "https://duckduckgo.com/?q=scrap+data+flutter+dart";
  List songArtists = [];
  List songNames = [];
  List songLinks = [];
